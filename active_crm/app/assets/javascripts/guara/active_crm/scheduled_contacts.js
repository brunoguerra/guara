...
var ScheduledContacts = {
  ...
  init: function(ignored_customers, new_scheduled_contacts, close_negociation, customer_group){
    ...
    $('#customer-scheduled tbody tr').click(function(){
      me.slide_customer_content($(this), true);
    });
  },
  ...
  */
  ...
  btn_finish_deal: function() {
    var me = this;
    var btn = $('<a>'+I18n.t('active_crm.scheduled.contacts.ending_deal')+'</a>').addClass('btn btn-danger');
    btn.on('click', function() {
              me.open_dialog_confirm(I18n.t('active_crm.scheduled.contacts.ending_deal')+ '?', I18n.t('active_crm.scheduled.contacts.ending_deal')+ '?', function(dialog){
  ...
  btn_ignore_customer: function() {
    var me = this;
    var btn = $('<a>'+I18n.t('active_crm.scheduled.contacts.ignore_customer')+'</a>').addClass('btn btn-warning');
    btn.on('click', function() {
