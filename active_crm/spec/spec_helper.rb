...
def config_transactional(config)
  ...
  except_tables = %w[SystemAbility SystemModule SystemTaskStatus SystemTaskResolution State City BusinessSegment BusinessActivity Lot Equipment EquipmentLocal EquipmentLocalLane InfractionType PropertyType].collect { |e| pluralize_without_count(2, e.underscore) }
