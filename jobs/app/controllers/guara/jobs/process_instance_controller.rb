  ...
  module Jobs
    class ProcessInstanceController < Guara::BaseController
      ...
      def create_step_instance_attrs        
        ...
        if @process_instance.custom_prcess.has_hook? && @process_instance.custom_prcess.hook.respond_to?(:step_instace_after_save)
          @step = Step.find @step_id
          @process_instance.custom_prcess.hook.step_instace_after_save(attrs, @process_instance, @step)
        end
      end
