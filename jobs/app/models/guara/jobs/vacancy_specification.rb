...
class Guara::Jobs::VacancySpecification < ActiveRecord::Base
	    attr_accessible :business_action, :role, :salary_requirement, :salary_requirement_id
	    
	 	belongs_to :salary_requirement
	    ...
	    accepts_nested_attributes_for :salary_requirement
